  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <!-- <h1><a href="#intro" class="scrollto"> Malang</a></h1> -->
        <!-- Uncomment below if you prefer to use an image logo -->
        <a href="#intro"><img src="{{ asset('assets/frontend/img/logo.png') }}" alt="" title=""></a>
      </div>
    ...
    <section id="advanced-features">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="{{ asset('assets/frontend/img/advanced-feature-1.jpg') }}" alt="">
      ...
      <div class="features-row">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-left" src="{{ asset('assets/frontend/img/advanced-feature-2.jpg') }}" alt="">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="{{ asset('assets/frontend/img/advanced-feature-3.jpg') }}" alt="">
              <div class="wow fadeInLeft">
                <h2>Duis aute irure dolor in reprehenderit in voluptate velit esse</h2>
                <h3>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
    ...
    <section id="clients">
      <div class="container">
        ...
        <div class="row wow fadeInUp">
          ...
          <div class="col-md-2">
            <img src="{{ asset('assets/frontend/img/clients/client-1.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ asset('assets/frontend/img/clients/client-2.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ asset('assets/frontend/img/clients/client-3.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ asset('assets/frontend/img/clients/client-4.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ asset('assets/frontend/img/clients/client-5.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ asset('assets/frontend/img/clients/client-6.png') }}" alt="">
          </div>
      ...
      <div class="container">
        ...
        <div class="row wow fadeInUp">
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{ asset('assets/frontend/img/team/team-1.jpg') }}" alt=""></div>
              <h4>Walter White</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{ asset('assets/frontend/img/team/team-2.jpg') }}" alt=""></div>
              <h4>Sarah Jhinson</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{ asset('assets/frontend/img/team/team-3.jpg') }}" alt=""></div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{ asset('assets/frontend/img/team/team-4.jpg') }}" alt=""></div>
              <h4>Amanda Jepson</h4>
